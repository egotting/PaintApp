...
public class Canvas extends JPanel {
    ...
    public Canvas(int targetWidth, int targetHeight) {
        ...
        MouseAdapter ma = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                g.setColor(Canvas.this.color);
                g.fillRect(x, y, STROKE_SIZE, STROKE_SIZE);
                g.dispose();

                // start current path
                currentPath = new ArrayList<>(25);
                currentPath.add(new ColorPoint(x, y, Canvas.this.color));
            }

            @Override
            public void mouseReleased(MouseEvent e) {
                // add a current path to all paths
            ...
            public void mouseDragged(MouseEvent e) {
                ...
                g2d.setColor(Canvas.this.color);
                ...
                ColorPoint nextPoint = new ColorPoint(e.getX(), e.getY(), Canvas.this.color);
    ...
    protected void paintComponent(Graphics g){
        ...
        // redraws all the paths created so far
